...
import 'package:minibank/pages/transaksi/pdf_invoice_page.dart';
...
class PaymentSuccessPage extends StatelessWidget {
  ...
  PaymentSuccessPage(
      ...
      required this.saldo,
      this.email = "", // Default empty like in MainPage if not provided
      this.nim});
        ...
        child: Column(
          children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text("Laporan Pembayaran Cicilan",
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(_formatDateTime(transactionTime),
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              const Divider(),
                              _buildRow("Total Dibayar", "Rp 450.000",
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              _buildRow("Baju PDH", "Rp. 10.000/minggu",
                                  isSmall: true),
                              _buildRow("Uang Kuliah", "Rp 145.000/minggu",
                                  isSmall: true),
                              _buildRow(
                                  "Uang Sertifikasi MOS", "Rp 50.000/minggu",
                                  isSmall: true),
                              _buildRow("Uang UPM", "Rp 20.000/minggu",
                                  isSmall: true),
                              const Divider(),
                              _buildRow("Subtotal per minggu", "Rp 225.000",
                                  isBold: true),
                            ],
                          ),
                        ),
            ...
            Row(
              ...
              children: [
                _buildActionButton(
                    Icons.download, "Download", const Color(0xFF304FFE), () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        // KIRIM DATA KE PDF INVOICE
                ...
                _buildActionButton(
                    Icons.print, "Print", Colors.grey[800]!, () {}),
                const SizedBox(width: 8),
  ...
  Widget _buildRow(String label, String value,
      {bool isBold = false, Color? color, bool isSmall = false}) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(label,
              style: TextStyle(
                  fontSize: isSmall ? 12 : 14, color: Colors.grey[700])),
          Text(value,
              style: TextStyle(
